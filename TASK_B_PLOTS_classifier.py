...
from Prediction_analysis import all_2_start, all_2_end, all_3_start, all_3_end, all_4_start, all_4_end, \
    ...
    ks_k_2_MEAN, ks_s_2_MEAN, ks_k_3_MEAN, ks_s_3_MEAN, ks_k_4_MEAN, ks_s_4_MEAN, \
    kg_k_2_MEAN, kg_g_2_MEAN, kg_k_3_MEAN, kg_g_3_MEAN, kg_k_4_MEAN, kg_g_4_MEAN, \
    go_g_2_MEAN, go_o_2_MEAN, go_g_3_MEAN, go_o_3_MEAN, go_g_4_MEAN, go_o_4_MEAN, \
    so_s_2_MEAN, so_o_2_MEAN, so_s_3_MEAN, so_o_3_MEAN, so_s_4_MEAN, so_o_4_MEAN
...
ks_k = [ks_k_2_MEAN, ks_k_3_MEAN, ks_k_4_MEAN]
ks_s = [ks_s_2_MEAN, ks_s_3_MEAN, ks_s_4_MEAN]
...
kg_k = [kg_k_2_MEAN, kg_k_3_MEAN, kg_k_4_MEAN]
kg_g = [kg_g_2_MEAN, kg_g_3_MEAN, kg_g_4_MEAN]
...
go_g = [go_g_2_MEAN, go_g_3_MEAN, go_g_4_MEAN]
go_o = [go_o_2_MEAN, go_o_3_MEAN, go_o_4_MEAN]
...
so_s = [so_s_2_MEAN, so_s_3_MEAN, so_s_4_MEAN]
so_o = [so_o_2_MEAN, so_o_3_MEAN, so_o_4_MEAN]
