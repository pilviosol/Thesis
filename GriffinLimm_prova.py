...
'''
# OK DI BASE GRIFFINLIMM FUNZIONA
'''
...
feature_np = np.load('/nas/home/spol/Thesis/URPM_vn_fl/single_feature_vn/AuSep_1_vn_01_Jupiter_STFTMAG.npy_chunk_1.npy')
...
scipy.io.wavfile.write('/nas/home/spol/Thesis/GriffinLimm.wav', 22050, y_inv)
