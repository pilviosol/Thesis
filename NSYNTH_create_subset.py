...
extract_subset(nsynth_test_path, nsynth_test_path_subset, 'vocal_synthetic')
extract_subset(nsynth_train_path, nsynth_train_path_subset, 'flute_acoustic')
extract_subset(nsynth_train_path, nsynth_train_path_subset, 'vocal_synthetic')
extract_subset(nsynth_valid_path, nsynth_valid_path_subset, 'flute_acoustic')
extract_subset(nsynth_valid_path, nsynth_valid_path_subset, 'vocal_synthetic')
