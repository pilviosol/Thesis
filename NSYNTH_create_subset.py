...
extract_subset_with_path(nsynth_train_path, nsynth_train_path_subset, 'organ_electronic', 'reducted_organ')
# extract_subset(nsynth_valid_path, nsynth_valid_path_subset, 'flute_acoustic')
# extract_subset(nsynth_valid_path, nsynth_valid_path_subset, 'keyboard_electronic')
