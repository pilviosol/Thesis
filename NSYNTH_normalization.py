...
original_flute_path = '/nas/home/spol/Thesis/NSYNTH/NSYNTH_' + which_set + '_SUBSET/HQ_features_matching_flute_' +\
                      which_set + '/'
# original_string_path = '/nas/home/spol/Thesis/NSYNTH/NSYNTH_' + which_set + '_SUBSET/features_matching_string_1104_' +\
#                        which_set + '/'

normalised_flute_path = '/nas/home/spol/Thesis/NSYNTH/NSYNTH_' + which_set + '_SUBSET/HQ_FW_normalised_flute_' \
                        + which_set + '/'
# normalised_string_path = '/nas/home/spol/Thesis/NSYNTH/NSYNTH_' + which_set + '_SUBSET/FW_normalised_string_' \
#                          + which_set + '/'
