...
flute_folder_min_max = fw_normalise(path_features_flute, normalised_guitar_path, min_max_flute)
...
string_folder_min_max = fw_normalise(path_features_string, normalised_guitar_path, min_max_string)
...
keyboard_folder_min_max = fw_normalise(path_features_keyboard, normalised_guitar_path, min_max_keyboard)
...
organ_folder_min_max = fw_normalise(path_features_organ, normalised_guitar_path, min_max_organ)
