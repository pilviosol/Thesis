...
test_path_file = "/nas/home/spol/Thesis/NSYNTH/NSYNTH_TEST/nsynth-test/audio/string_acoustic_057-072-050.wav"
...
fig = plt.figure()
img = plt.imshow(10*np.log10(stft_mag + 1e-3), cmap=plt.cm.viridis, origin='lower', extent=[0, 501, 0, 513], aspect='auto')
