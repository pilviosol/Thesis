...
--save_dir=gs://ddsp_training/VV_model \
--batch_size=128\
--learning_rate=0.001
"""
...
def get_region():
  ...
  if region == '(unset)':
    region = prompt_value('Region for training the VV_model', 'europe-west4')
  return region
...
def get_input():
  ...
  msg = 'Path for saving VV_model, snapshots and summaries'
  if FLAGS.save_dir:
