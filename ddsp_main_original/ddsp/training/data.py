  ...
  def __init__(self,
    ...
    Args:
      ...
      suffix: Choices include [None, 'batched', 'unbatched'], but broadly
        ...
        containing segmented audio VV_samples in 4 seconds. With the "unbatched"
        suffix, the dataloader will load tfrecords containing unsegmented
        VV_samples which could be used for learning note sequence in URMP dataset.
...
class UrmpMidiUnsegmented(Urmp):
  ...
  Unsegmented here means that the data VV_samples are not segmented to 4-second
